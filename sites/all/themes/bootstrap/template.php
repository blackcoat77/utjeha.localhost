...
function bootstrap_bootstrap_search_form_wrapper(&$variables) {
 ...
 function bootstrap_process_page(&$variables)  {
     drupal_add_js(drupal_get_path('theme', 'bootstrap') . '/js/jquery.mousewheel-3.0.6.pack');
     drupal_add_js(drupal_get_path('theme', 'bootstrap') . '/js/fancybox/jquery.fancybox.pack.js');
     drupal_add_css(drupal_get_path('theme', 'bootstrap') . '/js/fancybox/jquery.fancybox.css');
